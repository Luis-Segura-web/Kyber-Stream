...
open class ChannelsViewModel @AssistedInject constructor(
    ...
    // Actualiza la información de pistas desde el motor actual
    ...
    fun selectAudioTrack(trackId: Int) {
        viewModelScope.launch {
            try {
                ...
                Log.e("ChannelsViewModel", "selectAudioTrack error: ${e.message}")
            }
        }
    }
    ...
    fun selectSubtitleTrack(trackId: Int) {
        viewModelScope.launch {
            try {
                ...
                Log.e("ChannelsViewModel", "selectSubtitleTrack error: ${e.message}")
            }
        }
    }
    ...
    private fun observeCurrentEngine() {
        ...
        engineObservationJob = viewModelScope.launch {
            kotlinx.coroutines.flow.combine(
                ...
                if (state == com.kybers.play.core.player.PlayerState.READY || state == com.kybers.play.core.player.PlayerState.PLAYING) {
                    updateTrackInfo()
                }
            }
        }
