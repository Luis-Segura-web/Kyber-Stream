...
fun UniversalPlayerControls(
    ...
    // Centro: navegación o saltos
    showNextPrevious: Boolean = false,
    showSeekJumps: Boolean = false,
    onNext: () -> Unit = {},
    onPrevious: () -> Unit = {},
    onSeekForward: () -> Unit = {},
    onSeekBackward: () -> Unit = {},
    ...
    // Reintentos/estado del reproductor
    ...
    AnimatedVisibility(
        ...
        Box(
            ...
            BottomControls(
                ...
                duration = duration,
                showSeekBar = showSeekBar && (onSeek != null) && (duration > 0L || !showNextPrevious),
                onSeek = onSeek?.let { cb -> { pos: Long -> cb(pos); onAnyInteraction() } },
